...
The model remains deliberately reduced: normalized thermal units, coarse surface cells, approximate convex log contacts, sampled terrain, and a maximum of twelve solid char fragments. It is not a CFD solver or a calibrated structural fire model. The stone ring remains scenery rather than a collision enclosure.
